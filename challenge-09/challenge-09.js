...
( function() {
    ...
    */
    subtractionFunction = calculator( 6, 5 );
    multiplicationFunction = calculator( 6, 5 );
    divisionFunction = calculator( 20, 5 )
    
    modFunction = calculator( 20, 5 ); 
    ...
    chamada.
    */
    console.log( 'O resultado da subtração é: ' + subtractionFunction ( function(number1, number2) {
        return number1 - number2;
    }) );
    // ?

    console.log( 'O resultado da multiplicação é: ' + multiplicationFunction( function(number1, number2) {
        return number1 * number2;
    }) );
    // ?

    console.log( 'O resultado da divisão é: ' + divisionFunction( function(number1, number2) {
        return number1 / number2;
    }) );
    // ?

    console.log( 'O resto da divisão é: ' + modFunction( function(number1, number2) {
        return number1 % number2;
    }) );
    // ?
})();