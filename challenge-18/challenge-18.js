(function(){
    ...
    */
    ...
    function cleanCPF(cpf){
        return cpf.replace(/\D/g, '');D maiusculo pega todos os caracteres menos os numeros;
    }
    ...
    */
    var cleanCPF1 = cleanCPF('049-214 3421-1');
    var cleanCPF2 = cleanCPF('210.458.522-05');
    var cleanCPF3 = cleanCPF('735 500 794 - 22');
    var cleanCPF4 = cleanCPF('101.123-131x32');
    var regexCPF = /(\d{3})(\d{3})(\d{3})(\d{2})/;
    
    function formatCPF(regex, n1, n2, n3, n4) {
        return n1 + '.' + n2 +'.'+ n3 + '-' + n4;
    }
    console.log( '\nFormatando CPFs corretamente:' );
    console.log(cleanCPF1.replace(regexCPF, formatCPF));
    console.log(cleanCPF2.replace(regexCPF, formatCPF));
    console.log(cleanCPF3.replace(regexCPF, formatCPF));
    console.log(cleanCPF4.replace(regexCPF, formatCPF));
    ...
    ["junho", "julho"]
    */
    var regexMouth = /junho|julho/g //ju[nl]ho/g
    console.log( '\nMatch com as palavras "junho" ou "julho" para a frase "Os meses de janeiro, junho e julho começam com a letra j.":' );
    console.log("Os meses de janeiro, junho e julho começam com a letra j.".match(regexMouth));
   ...
   var regexTag = /\<(\w+)\>([^<]+)\<\/\w+\>/g
   //var regexTag = /<(\w+)>([^<]+)<\/w+>/g; 
   var matchTag = "<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>";
    console.log( '\nFazer replace dos textos das tags:' );
    console.log(matchTag.replace(regexTag, "<$1>O texto dentro da tag $1 é $2\n" ));
})();